...
// Base © °zilo°Hw Mods : Copyan Dari Base Dika

› Create By © ꪶ⸸⁶⁶⁶𝚣𝚒𝚕𝚘𝚗𝚘𝚌𝚞𝚛𝚎⁶⁶⁶⸸ꫂ͢
› Base Ori © ꪶ⸸⁶⁶⁶𝚣𝚒𝚕𝚘𝚗𝚘𝚌𝚞𝚛𝚎⁶⁶⁶⸸ꫂ͢
› Copyan Base Dika Hisoka Morou

🌷 KALAU MAU RENAME TARO CREDITS GUA : © ꪶ⸸⁶⁶⁶𝚣𝚒𝚕𝚘𝚗𝚘𝚌𝚞𝚛𝚎⁶⁶⁶⸸ꫂ͢*/
...
let teks = `${q}`
{
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/8baeead8bfbea49ac8e48.jpg' }, caption: `🔥 ${teks} ${iphone}` }, { quoted: doc })
}
}
break
case 'jadivirtext2': {
...
let teks = `${q}`
{
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/8baeead8bfbea49ac8e48.jpg' }, caption: `🔥 ${teks} ${iphone1}` }, { quoted: doc })
}
}
break
case 'jadivirtex3t': {
...
let teks = `${q}`
{
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/8baeead8bfbea49ac8e48.jpg' }, caption: `🔥 ${teks} ${iphone2}` }, { quoted: doc })
}
}
break
case 'jadivirtext4': {
...
let teks = `${q}`
{
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/8baeead8bfbea49ac8e48.jpg' }, caption: `🔥 ${teks} ${iphone3}` }, { quoted: doc })
}
}
break
case 'jadivirtext5': {
...
let teks = `${q}`
{
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/8baeead8bfbea49ac8e48.jpg' }, caption: `🔥 ${teks} ${iphone4}` }, { quoted: doc })
}
}
break
case 'jadivirtext6': {
...
let teks = `${q}`
{
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/8baeead8bfbea49ac8e48.jpg' }, caption: `🔥 ${teks} ${iphone5}` }, { quoted: doc })
}
}
break
case 'jadivirtext7': {
...
let teks = `${q}`
{
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/8baeead8bfbea49ac8e48.jpg' }, caption: `🔥 ${teks} ${iphone6}` }, { quoted: doc })
}
}
break
case 'jadivirtext8': {
...
let teks = `${q}`
{
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/8baeead8bfbea49ac8e48.jpg' }, caption: `🔥 ${teks} ${buttonkal}` }, { quoted: doc })
}
}
break
case 'jadivirtext9': {
...
let teks = `${q}`
{
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/8baeead8bfbea49ac8e48.jpg' }, caption: `🔥 ${teks} ${buttonvirus}` }, { quoted: doc })
}
}
break
case 'jadivirtext10': {
...
let teks = `${q}`
{
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/8baeead8bfbea49ac8e48.jpg' }, caption: `🔥 ${teks} ${ngazap(prefix)}`}, { quoted: doc })
}
}
break
case 'jadibuginvite': {
...
{
"optionName": "SALAM BROTHER BY © °zilo°͢"
}
],
...
break
//=================================================//
case 'zilotroli2': case 'zilotrol': case 'jutrol': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
break
case 'zilotroli3': case 'zilotrol2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
for (let i = 0; i < jumlah; i++) {
 ...
 break
//=================================================//
case 'zilodocu': case 'zilodraknes':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'duc': case 'ziloslebew': case 'cumadocu': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'zilovirtext1': case 'zilozsu': case 'crashar1': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
break
case 'zilovirtext2': case 'zilotol': case 'crashar2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'zilovirtext3': case 'zilomemek': case 'crashar3': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'zilovirtext4': case 'zilocontol': case 'crashar4': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'zilovirtext5': case 'zilotextv': case 'crashar5': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'zilovirtext6': case 'zilogas': case 'crashar6':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'zilovirtext7': case 'zilovirtext': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'zilovirtext8': case 'zilovirtext1': case 'crashar7':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'zilovirtext9': case 'zilovirtext2': case 'crashar8':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'zilovirtext10': case 'zilovirtext3': case 'crashar9': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'zilobug1': case 'zilocrash': case 'crashar10':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'zilobug2': case 'zilocrash1': case 'crashar11': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
{ quickReplyButton: { displayText: `HW MODS WA`, id: `KILL`}},
 ...
 break
//=================================================//
case 'zilobug3': case 'zilocrash2': case 'crashar12': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'zilobug4': case 'zilocrash3': case 'crashar13':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'zilobug5': case 'zilocrash4': case 'crashar14': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
case 'zilobug6': case 'zilocrash5': case 'crashar15':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'zilobug7': case 'zilocrash6': case 'crashar16':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'zilobug8': case 'zilocrash7': case 'crashar17': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
case '🌷': case 'crashmek': case 'ampunsuhu': case 'ahyangbetul': case 'okemek': case 'zilonih': case 'crashar18': case 'mexdemam': case 'zilo1': case 'zilo2': case 'zilo3': case 'zilo4': case 'zilo5': case 'zilo6': case 'zilo7': case 'zilo8': case 'zilo9': case 'zilo10': case 'zilo11': case 'zilo12': case 'zilo13': case 'zilo14': case 'zilo15': case 'zilo16': case 'zilo17': case 'zilo18': case 'zilo19': case 'zilo20': case 'zilo21': case 'zilo22': case 'zilo23': case 'zilo24': case 'zilo25': case 'zilo26': case 'zilo27': case 'zilo28':
case 'zilo29':
case 'zilo30':
case 'zilo31':
case 'zilo32':
...
break
//=================================================//
case 'zilostik': case 'zilokangbug': case 'buttonkematian': case 'crashar19': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'zilobugie': case 'zilokangbug1': case 'crashar20': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'zilobutton': case 'zilokangbuttton': case 'testbutton': case 'inibutton': 
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'zilobokep': case 'zilongentod': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
if (isBan) throw sticBanLu(from)
haikal.public = true
reply('Sukse Change To Zilo Memek')
}
break
//=================================================//
case 'self': {
...
if (isBan) throw sticBanLu(from)
haikal.public = false
reply('Sukses Change To Zilo Kontol')
}
break
//=================================================//
case 'nowa': {
...
┗━━⊱
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
© °zilo°͢`, contextInfo:{"externalAdReply": {"title": `SC °zilo°͢`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
┣❏afk { kasih reactions }
┣❏ziloghoib [ on / off ]
┣❏zilojagoan [ reply target ]
┣❏zilosange [ Harus Menjadi Admin ]
...
┣❏crashmex 628xxx|5|5
┣❏ziloskuy 628xxx
┣❏zilosantet 628xxx@s.whatsapp.net|10|10s
┣❏catalogpc 628xxx@s.whatsapp.net|10|10s
┗━━⊱[°zilo°]
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Ketik > m.chat ( di group dulu )
┏━━⊱[ GROUP ]
┣❏gaszilo 112674448xxx
┣❏zilosantetgc  1237891xxxx@g.us|10|10s
...
┗━━⊱[°zilo°]`,
contextInfo:{"externalAdReply": {"title": `SC °zilo°͢`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
