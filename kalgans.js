...
🌷 KALAU MAU RENAME TARO CREDITS GUA : zilo botz☆ */
...
browser: ['Zilol Multi Device','Safari','1.0.0'],
auth: state})
//=================================================//
...
let buttons = [
{buttonId: `zilo botz☆`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
